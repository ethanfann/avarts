...
import { invert, cloneDeep, isEmpty, isArray, map, isObject, isDate, isRegExp, isFunction, extend, mapValues, set } from 'lodash';
...
import { pathExistsSync, readFileSync, existsSync, writeFileSync, mkdirpSync, pathExists } from 'fs-extra';
...
class Environment {
    constructor(home, out = new Output(), version) {
        ...
        mkdirpSync(dirname(this.rcPath));
    }
    async load() {
    ...
    async loadGlobalRC() {
        const globalFile = this.rcPath && pathExistsSync(this.rcPath) ? readFileSync(this.rcPath, 'utf-8') : undefined;
